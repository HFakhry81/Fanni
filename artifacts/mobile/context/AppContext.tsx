...
const translations: Record<string, Record<Language, string>> = {
  ...
  "admin.categories": { ar: "الفئات والتخصصات", en: "Categories" },
  "admin.ledger": { ar: "دفتر الأستاذ", en: "Ledger" },
  "admin.sysAdmins": { ar: "مسئولو النظام", en: "System Admins" },
  "admin.users.hub.title": { ar: "المستخدمون", en: "Users" },
  "admin.users.clients": { ar: "العملاء", en: "Clients" },
  "admin.users.clientsDesc": { ar: "إدارة حسابات العملاء وبياناتهم", en: "Manage client accounts & data" },
  "admin.users.technicians": { ar: "الفنيون", en: "Technicians" },
  "admin.users.techniciansDesc": { ar: "إدارة الفنيين ومراقبتهم", en: "Manage & monitor technicians" },
  "admin.users.loginLogs": { ar: "سجل تسجيل الدخول", en: "Login Log" },
  "admin.users.loginLogsDesc": { ar: "مراقبة محاولات تسجيل الدخول", en: "Monitor login attempts" },
  "admin.users.collection": { ar: "التحصيل والاسترداد", en: "Collection & Recovery" },
  "admin.users.collectionDesc": { ar: "تقارير المدفوعات والأرصدة", en: "Payments & balance reports" },
  "admin.tech.liveMap": { ar: "خريطة المراقبة الحية", en: "Live Monitoring Map" },
  "admin.tech.liveMapDesc": { ar: "رصد مواقع الفنيين في الوقت الفعلي", en: "Real-time technician tracking" },
  "admin.tech.missedAddresses": { ar: "معالجة العناوين غير المطابقة", en: "Unmatched Addresses" },
  "admin.tech.missedAddressesDesc": { ar: "مراجعة وتصحيح عناوين الطلبات", en: "Review & fix address issues" },
  "admin.tech.pendingApproval": { ar: "فنيون بانتظار الموافقة", en: "Pending Approval" },
  "admin.tech.pendingApprovalDesc": { ar: "مراجعة طلبات التسجيل الجديدة", en: "Review new registrations" },
  "admin.tech.list": { ar: "قائمة الفنيين", en: "All Technicians" },
  "admin.tech.listDesc": { ar: "عرض وإدارة جميع الفنيين", en: "View & manage all technicians" },
  "admin.coll.received": { ar: "أرصدة مستلمة", en: "Received Balances" },
  "admin.coll.receivedDesc": { ar: "تقارير المبالغ المستلمة في المحفظة أو الحساب", en: "Reports of received payments" },
  "admin.coll.refunded": { ar: "أرصدة مستردة", en: "Refunded Balances" },
  "admin.coll.refundedDesc": { ar: "جميع عمليات الاسترداد ومبرراتها", en: "All refund transactions & reasons" },
  "admin.coll.techBalances": { ar: "أرصدة الفنيين", en: "Technician Balances" },
  "admin.coll.techBalancesDesc": { ar: "رصيد نقاط الفنيين للتحقق", en: "Technician point balances" },
  "admin.coll.commission": { ar: "عمولة التطبيق", en: "App Commission" },
  "admin.coll.commissionDesc": { ar: "العمولات المحصلة بعد حساب الاستردادات", en: "Net commissions after refunds" },
  "common.back": { ar: "رجوع", en: "Back" },
  "common.search": { ar: "بحث...", en: "Search..." },
  "common.noData": { ar: "لا توجد بيانات", en: "No data available" },
  "common.comingSoon": { ar: "قريباً", en: "Coming Soon" },
  "common.comingSoonDesc": { ar: "هذه الميزة قيد التطوير وستتوفر قريباً", en: "This feature is under development" },
  "common.egpShort": { ar: "ج.م", en: "EGP" },
  ...
  "profile.revokeOtherSessions": { ar: "تسجيل الخروج من جميع الأجهزة الأخرى", en: "Sign out of all other devices" },
  "profile.revokeOtherSessionsConfirmTitle": { ar: "تسجيل الخروج من الأجهزة الأخرى", en: "Sign out of other devices" },
  "profile.revokeOtherSessionsConfirmMessage": { ar: "سيتم إنهاء جميع الجلسات النشطة الأخرى. هل تريد المتابعة؟", en: "All other active sessions will be ended. Continue?" },
  "profile.revokeOtherSessionsSuccess": { ar: "تم تسجيل الخروج من جميع الأجهزة الأخرى", en: "Signed out of all other devices" },
  "profile.revokeOtherSessionsFailed": { ar: "فشل تسجيل الخروج من الأجهزة الأخرى", en: "Failed to sign out of other devices" },
  ...
  "tech.noJobsHint": { ar: "عندما تقبل طلباً سيظهر هنا لمتابعته حتى الإكمال", en: "Accepted jobs appear here so you can track them through completion" },
  "tech.noJobsSetupHint": { ar: "أكمل مهنتك ومنطقة خدمتك لتبدأ في تلقي الطلبات", en: "Set your profession and service area to start receiving jobs" },
  ...
  "tech.noProfession": { ar: "لم تحدد مهنتك بعد", en: "Profession not set yet" },
  "tech.noProfessionPrompt": { ar: "حدد مهنتك لتصلك الطلبات المناسبة لمنطقتك", en: "Set your profession to receive matching orders in your area" },
  "tech.noAvailableOrders": { ar: "لا توجد طلبات متاحة الآن", en: "No Available Orders Right Now" },
  "tech.noAvailableOrdersHint": { ar: "ستظهر هنا الطلبات الجديدة في منطقتك ومهنتك فور ورودها.", en: "New requests in your service area and profession will appear here as they come in." },
  "tech.noAvailableOrdersSetupHint": { ar: "حدد مهنتك ومنطقة خدمتك أولاً لتصلك الطلبات المناسبة.", en: "Set your profession and service area first so matching orders can reach you." },
  "tech.setServiceArea": { ar: "تحديد منطقة الخدمة", en: "Set Your Service Area" },

  // Payments
  "payment.title": { ar: "إرسال طلب دفع", en: "Submit Payment Request" },
  "payment.method.bank_transfer": { ar: "تحويل بنكي", en: "Bank Transfer" },
  "payment.method.instapay": { ar: "إنستا باي", en: "InstaPay" },
  "payment.method.e_wallet": { ar: "محفظة إلكترونية", en: "E-Wallet" },
  "payment.reference": { ar: "رقم مرجع التحويل", en: "Transfer Reference Number" },
  "payment.note": { ar: "ملاحظات (اختياري)", en: "Notes (optional)" },
  "payment.submit": { ar: "إرسال طلب الدفع", en: "Submit Payment Request" },
  "payment.pending": { ar: "في انتظار تأكيد الإدارة", en: "Awaiting admin confirmation" },
  "payment.confirmed": { ar: "تم التأكيد وإضافة النقاط", en: "Confirmed — points credited" },
  "payment.rejected": { ar: "تم رفض الطلب", en: "Request rejected" },
  "payment.historyTitle": { ar: "طلبات الدفع السابقة", en: "Previous Requests" },
  "payment.noHistory": { ar: "لا توجد طلبات سابقة", en: "No previous requests" },
  "payment.howTo": { ar: "كيفية الشراء", en: "How to buy" },
  "payment.step1": { ar: "اختر الباقة واضغط عليها", en: "Select a package and tap it" },
  "payment.step2": { ar: "حوّل المبلغ إلى الحساب المعروض", en: "Transfer amount to the account shown" },
  "payment.step3": { ar: "أدخل رقم مرجع التحويل وأرسل الطلب", en: "Enter transfer reference and submit" },
  "payment.step4": { ar: "ستضاف النقاط بعد تأكيد الإدارة", en: "Points added after admin confirms" },
  ...
  "payment.instapayId": { ar: "رقم إنستا باي", en: "InstaPay ID" },
  "payment.copyTip": { ar: "اضغط للنسخ", en: "Tap to copy" },
  "payment.successTitle": { ar: "تم إرسال الطلب", en: "Request Submitted" },
  "payment.successMsg": { ar: "سنضيف النقاط بعد مراجعة وتأكيد التحويل من قِبل الإدارة", en: "We'll credit your points once admin verifies the transfer" },

  // Wallet / Points system
  "wallet.title": { ar: "محفظة النقاط", en: "Points Wallet" },
  "wallet.balance": { ar: "رصيدك الحالي", en: "Your Balance" },
  "wallet.points": { ar: "نقطة", en: "pts" },
  "wallet.buyPoints": { ar: "شراء نقاط", en: "Buy Points" },
  "wallet.history": { ar: "سجل المعاملات", en: "Transaction History" },
  "wallet.noHistory": { ar: "لا توجد معاملات بعد", en: "No transactions yet" },
  "wallet.insufficientPoints": { ar: "رصيدك من النقاط غير كافٍ", en: "Insufficient points balance" },
  "wallet.unlockFor": { ar: "فتح البيانات مقابل", en: "Unlock for" },
  "wallet.unlocked": { ar: "تم الفتح ✓", en: "Unlocked ✓" },
  "wallet.unlocking": { ar: "جارٍ الفتح…", en: "Unlocking…" },
  "wallet.lockedHint": { ar: "اضغط لرؤية بيانات التواصل مع العميل", en: "Tap to reveal client contact details" },
  "wallet.contactRevealed": { ar: "بيانات التواصل", en: "Contact Details" },
  "wallet.callClient": { ar: "اتصال بالعميل", en: "Call Client" },
  "wallet.whatsapp": { ar: "واتساب", en: "WhatsApp" },
  "wallet.pkg.basic": { ar: "الحزمة الأساسية", en: "Basic Package" },
  "wallet.pkg.bronze": { ar: "الحزمة البرونزية", en: "Bronze Package" },
  "wallet.pkg.gold": { ar: "الحزمة الذهبية", en: "Gold Package" },
  "wallet.egp": { ar: "ج.م", en: "EGP" },
  "wallet.save": { ar: "وفّر", en: "Save" },
  "wallet.dispute": { ar: "الإبلاغ عن مشكلة", en: "Report an Issue" },
  "wallet.disputeHint": { ar: "إذا لم تتمكن من الاتصال بالعميل يمكنك الإبلاغ لاسترداد نقاطك", en: "If you couldn't reach the client you may report to get your points back" },
  "wallet.type.package_purchase": { ar: "شراء حزمة", en: "Package Purchase" },
  "wallet.type.lead_unlock": { ar: "فتح طلب", en: "Lead Unlock" },
