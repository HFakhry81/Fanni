...
import { View, Text, StyleSheet, FlatList, TouchableOpacity, ScrollView, Platform, Alert, Image, ActivityIndicator, Modal, TextInput, UIManager, Animated } from "react-native";
    ...
    return (
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        <KeyboardAwareScrollViewCompat contentContainerStyle={[styles.completeContent, { paddingBottom: botPad + 24 }]} keyboardShouldPersistTaps="handled">
          ...
          <FanniButton
            title={isRTL ? "إنهاء الطلب" : "Complete Order"}
