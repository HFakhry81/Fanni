...
const ALL_PERMISSIONS: Omit<Permission, "enabled">[] = [
  ...
  { id: "manage_wallet",    group: "Finance",      groupAr: "المالية",    label: "Adjust wallets and packages", labelAr: "تعديل المحافظ والباقات"  },
  { id: "manage_payments",  group: "Finance",      groupAr: "المالية",    label: "Confirm or reject payments", labelAr: "تأكيد أو رفض المدفوعات"   },
  { id: "manage_disputes",  group: "Finance",      groupAr: "المالية",    label: "Resolve point disputes",    labelAr: "فض نزاعات النقاط"           },
  { id: "manage_pricing",   group: "Finance",      groupAr: "المالية",    label: "Edit lead pricing",         labelAr: "تعديل تسعير الـ Lead"       },
  { id: "manage_expenses",  group: "Finance",      groupAr: "المالية",    label: "Record operating expenses", labelAr: "تسجيل المصروفات التشغيلية"  },
