  ...
  useEffect(() => {
    ...
    if (authUser) {
      ...
      setUser({
        ...
        street: (authUser as { street?: string | null }).street ?? undefined,
        buildingNo: (authUser as { buildingNo?: string | null }).buildingNo ?? undefined,
        floorNo: (authUser as { floorNo?: string | null }).floorNo ?? undefined,
        aptNo: (authUser as { aptNo?: string | null }).aptNo ?? undefined,
