/**
 * Migration 009 — Reseed locations with authoritative 2-level Egypt dataset
 * 27 governorates + 396 cities/areas; removes neighborhood rows and stale legacy entries.
 * Pure CommonJS — run with: node artifacts/api-server/migrations/009-reseed-locations.mjs
 */
...
const EGYPT_LOCATIONS = [
  { id:"cairo", ar:"القاهرة", en:"Cairo", areas:[
  ...
  { id:"giza", ar:"الجيزة", en:"Giza", areas:[
  ...
  { id:"alexandria", ar:"الإسكندرية", en:"Alexandria", areas:[
  ...
  { id:"dakahlia", ar:"الدقهلية", en:"Dakahlia", areas:[
  ...
  { id:"red_sea", ar:"البحر الأحمر", en:"Red Sea", areas:[
  ...
  { id:"beheira", ar:"البحيرة", en:"Beheira", areas:[
  ...
  { id:"fayoum", ar:"الفيوم", en:"Fayoum", areas:[
  ...
  { id:"gharbiya", ar:"الغربية", en:"Gharbiya", areas:[
  ...
  { id:"ismailia", ar:"الإسماعلية", en:"Ismailia", areas:[
  ...
  { id:"menofia", ar:"المنوفية", en:"Menofia", areas:[
  ...
  { id:"minya", ar:"المنيا", en:"Minya", areas:[
  ...
  { id:"qaliubiya", ar:"القليوبية", en:"Qaliubiya", areas:[
  ...
  { id:"new_valley", ar:"الوادي الجديد", en:"New Valley", areas:[
  ...
  { id:"suez", ar:"السويس", en:"Suez", areas:[
  ...
  { id:"aswan", ar:"اسوان", en:"Aswan", areas:[
  ...
  { id:"assiut", ar:"اسيوط", en:"Assiut", areas:[
  ...
  { id:"beni_suef", ar:"بني سويف", en:"Beni Suef", areas:[
  ...
  { id:"port_said", ar:"بورسعيد", en:"Port Said", areas:[
  ...
  { id:"damietta", ar:"دمياط", en:"Damietta", areas:[
  ...
  { id:"sharkia", ar:"الشرقية", en:"Sharkia", areas:[
  ...
  { id:"south_sinai", ar:"جنوب سيناء", en:"South Sinai", areas:[
  ...
  { id:"kafr_al_sheikh", ar:"كفر الشيخ", en:"Kafr Al sheikh", areas:[
  ...
  { id:"matrouh", ar:"مطروح", en:"Matrouh", areas:[
  ...
  { id:"luxor", ar:"الأقصر", en:"Luxor", areas:[
  ...
  { id:"north_sinai", ar:"شمال سيناء", en:"North Sinai", areas:[
  ...
  { id:"sohag", ar:"سوهاج", en:"Sohag", areas:[
...
async function main() {
  ...
  try {
    ...
    console.log("Deleted all old location rows");
    ...
    const { rows } = await client.query(
      "SELECT type, COUNT(*) AS c FROM locations GROUP BY type"
    );
    console.log("Reseed complete:", rows.map(r => `${r.type}: ${r.c}`).join(", "));
  } catch (err) {
