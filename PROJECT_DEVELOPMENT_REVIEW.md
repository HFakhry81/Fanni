...
آخر مراجعة: 22 أغسطس 2026 — وقفة استئناف: بعد `e06bf79`؛ التالي migrate ثم KYC
...
|---|---|---|---|
| 1 | [ ] | M4 تشغيل | migrate 017/018 على بيئة التطوير |
| 2 | [ ] | M1 | KYC: حالات وثيقة البطاقة + مخزن VPS (محول محلي جاهز) |
| 3 | [ ] | M3 | نزاع رقم خاطئ / عدم رد آلي + حد يومي |
| 4 | [ ] | M3/M5 | اختبار e2e حي: عميل → فني → جيوفنس |
| 5 | [ ] | M6 | قيد مزدوج + شاشة مصروفات + صافي ربح |
| 6 | [ ] | M7 | تشغيل Twilio في البيئة |
| 7 | [ ] | M8 | إعادة تجميع لوحة الأدمن (7 أقسام) |
| 8 | [ ] | M0 | أدوار يومية + شاشة تدقيق في التطبيق |
| 9 | [ ] | M4 | ربط OPay عند وصول الـ API |
| 10 | [ ] | M9 | تخزين الصور على VPS الإنتاجي |
| 11 | [ ] | M2 | Accuracy/Source وتأكيد موقع موحّد |
