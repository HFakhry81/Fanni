...
| 6 | [ ] | M7 | Twilio: ينقص Account SID وAuth Token من Console (Firebase جاهز OTP فقط) |
...
|---|---|---|---|
| 23 أغسطس 2026 | نشر VPS | سكربت `scripts/deploy-vps.sh` + CORS إنتاجي لنطاق UpNexa + قوالب Apache/PM2/env | تشغيل السكربت على الأصل (ليس Cloudflare)؛ SID Twilio؛ OPay |
