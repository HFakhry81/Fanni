...
1. شاشة مصروفات تشغيلية وتقرير صافي الربح.
2. سياسة الاستخدام (النقاط غير قابلة للسحب)؛ تخزين صور معتمد.
3. اختبارات تدفق عميل/فني/أدمن وtypecheck + migrate على بيئة التطوير.
